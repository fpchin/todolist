"""
Django settings for GTMS project - Base Settings.
"""
import os
...
ASGI_APPLICATION = 'gtms.asgi.application'

# Database
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default='postgresql://gtms_user:gtms_password@localhost:5432/gtms_db'),
        conn_max_age=600,
    )
}
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Golf Tournament Management System API',
    'DESCRIPTION': 'API for managing golf tournaments, players, scores, and results',
    'VERSION': '1.0.0',
